  ...
  return (
    <div className={`p-6 space-y-6 ${isDark ? "bg-gray-900 text-white" : "bg-white text-black"}`}>
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-4">
        ...
        <div className="flex flex-col md:flex-row gap-2">
          <input
            ...
            className={`border p-2 rounded ${isDark ? "bg-gray-800 text-white border-gray-600" : ""}`}
          />
          <button
            onClick={() => {
              setIsEditMode(false);
      ...
      <table className="w-full table-auto border mt-4">
        <thead className={`${isDark ? "bg-gray-700 text-white" : "bg-gray-200 text-black"} text-sm`}>
          <tr>
        ...
        <tbody>
          {students
            ...
            .map((s, index) => (
              <tr key={s.id} className={`text-center ${isDark ? "bg-gray-800" : ""}`}>
                <td className="p-2 border">DS0000{index + 1}</td>
                ...
                <td className="p-2 border">{s.parent}</td>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className={`${isDark ? "bg-gray-800 text-white" : "bg-white text-black"} p-6 rounded shadow-md w-[500px]`}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                required
                className={`border p-2 w-full rounded ${isDark ? "bg-gray-700 text-white border-gray-600" : ""}`}
              />
              <input
                name="age"
              ...
              <div className="flex justify-end gap-2">
                <button
                  ...
                  className={`px-4 py-2 border rounded ${isDark ? "border-gray-400" : ""}`}
                >
                  Cancel
                </button>
                <button
