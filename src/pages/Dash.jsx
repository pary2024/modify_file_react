...
const Dash = () => {
  ...
  return (
    <div
      className={`flex-1 p-4 sm:p-6 overflow-auto min-h-screen transition-colors duration-300 ${
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        ...
        <div className="flex items-center space-x-3 mt-4 md:mt-0">
          <div
            className={`relative rounded-lg px-3 py-2 flex items-center ${
          ...
          >
            ...
            <input
              type="text"
              placeholder="Search..."
              className={`bg-transparent outline-none w-32 sm:w-48 text-sm ${
        ...
        {stats.map((stat, index) => (
          ...
          >
            <div className="flex justify-between items-start mb-3">
              <div
                className={`${stat.bg} text-white p-2 rounded-lg flex items-center shadow-md`}
              >
                {stat.icon}
              </div>
