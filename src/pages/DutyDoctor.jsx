...
import { FaUserMd, FaUser, FaClinicMedical, FaPlus, FaSearch, FaCalendarAlt, FaTimes,FaTeeth,FaUserInjured,FaSave } from 'react-icons/fa';
...
const filteredDuties = Array.isArray(duties)
  ...
  // Modal component defined inside the main component
